...
export default function About() {
    ...
    <div className="about">
                ...
                <br></br>
                <p className="intro-para">I'm a computer systems student with a fervent passion for the intricacies that lie behind the scenes of our digital world. My primary focus is on devops, ensuring that the engine room of applications runs seamlessly and efficiently. I'm also deeply immersed in the realm of DevOps, always aiming to bridge the gap between software development and IT operations for smoother deployments. Cybersecurity is another domain close to my heart; I believe in fortifying our digital infrastructures and safeguarding data. Together, these disciplines shape my academic journey and fuel my aspirations in the tech world.</p>
